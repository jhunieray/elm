		...
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right hidden-xs hidden-sm">
					...
					<button class="btn btn-sm btn-primary btn-flat menu_btn" type="button" data-toggle="collapse" data-target="#panel_filters" aria-expanded="false" aria-controls="panel_filters" disabled=""><i class="fa fa-filter"></i> Filters</button>
				</div>
				<div class="box-tools hidden-md hidden-lg">
					...
					<button class="btn btn-sm btn-primary btn-flat menu_btn" type="button" data-toggle="collapse" data-target="#panel_filters" aria-expanded="false" aria-controls="panel_filters" title="Filters" disabled=""><i class="fa fa-filter"></i> </button>
				</div>
			</div>
			<div class="box-body">
				  					...
				  					<div class="form-group">
				  						...
				  						<div class="input-group">
					  						...
					  						<span class="input-group-btn">
												<button id="add_category" type="button" class="btn btn-flat btn-success" data-toggle="modal" data-target="#modal_category">
				  				...
				  				<div class="col-md-3">
				  					<div class="form-group">
				  						...
				  						<div class="input-group">
					  						...
					  						<span class="input-group-btn">
												<button id="add_list" type="button" class="btn btn-flat btn-success" data-toggle="modal" data-target="#modal_list">
								                    <i class="fa fa-plus"></i>
								                </button>
								            </span>
					  					</div>
						  		...
						  		<div class="box-body">
						  			<div class="row">
						  				...
						  				<div class="col-md-8">
						  					<div class="input-group">
						  						...
						  						<span class="input-group-btn">
													<button id="add_category" type="button" class="btn btn-flat btn-warning" data-toggle="modal" data-target="#modal_category">
									                    <i class="fa fa-plus"></i>
									                </button>
									            </span>
						  					</div>
						  			...
						  			<div class="row">
						  				...
						  				<div class="col-md-8">
						  					<div class="input-group">
						  						...
						  						<span class="input-group-btn">
													<button id="add_list" type="button" class="btn btn-flat btn-warning" data-toggle="modal" data-target="#modal_list">
									                    <i class="fa fa-plus"></i>
									                </button>
									            </span>
						  					</div>
						  			...
						  			<div class="row">
						  				...
						  				<div class="col-md-5 text-right">
											<button class="btn btn-warning btn-flat btn-sm" id="import_btn" disabled=""><i class="fa fa-upload fa-fw"></i> Import</button>
				...
				<div class="collapse custom_panel" id="panel_filters">
				  	<div class="row">
				  		<div class="col-md-8 col-md-offset-2">
						  	<?= form_open('api/subscribers/search', array('id' => 'form_filters', 'class' => 'form-horizontal')) ?>
						  	<div class="box box-info">
						  		<div class="box-body">
						  			<div class="row">
						  				<div class="col-md-12">
						  			...
						  			<div class="row">
						  				<div class="col-md-12">
						  					<div class="form-group">
						  						...
						  						<div class="col-md-3">
						  							<select class="form-control" name="email_operator">
						  			...
						  			<div class="row">
						  				<div class="col-md-12 text-right">
						  					<p id="filter_msg" class="pull-left"></p>
						  					<button type="button" class="btn btn-flat btn-default" data-toggle="collapse" data-target="#panel_filters" aria-expanded="false" aria-controls="panel_filters">Close</button>
						  					<button id="filter_subscriber" type="submit" class="btn btn-flat btn-primary">Apply</button>
						  				</div>
						  			</div>
						  		</div>
						  	</div>
